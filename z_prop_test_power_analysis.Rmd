...
Big query provides us with a generated Sequence of Events & Page Hits:
Page url << Event Category <<: Event Level

Thus when sampling from rows in our roled up daily data pipeline data, we should wait the probability of sampling by the occurrences of the associated Sequence.  

We should make use of as much data is possible where we can to improve the precision of our coefficient estimates.  
